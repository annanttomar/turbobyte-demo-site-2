  ...
  <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-16">
    <div className="max-w-4xl w-full bg-white p-8 rounded-lg shadow border border-gray-200">
      ...
      <div className="text-gray-700 space-y-6">
        <p>
          At TurboBytes Innovations, we take pride in offering reliable and affordable digital services, including website design, development, hosting, and maintenance. This Refund & Cancellation Policy outlines the terms under which cancellations and refunds are processed for services booked through our platform.
        </p>
        ...
        <div>
          ...
          <p className="mb-3">
            📧 <a href="mailto:support@turbobytes.in" className="text-blue-600 hover:text-blue-800">support@turbobytes.in</a>
          </p>
          <p>
        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            <p>
              This policy is applicable only for services offered by TurboBytes Innovations and does not cover any third-party tools, domains, or hosting purchased separately.
            </p>
          </div>
        </div>
      </div>
