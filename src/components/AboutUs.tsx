  ...
  <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-16">
    <div className="max-w-4xl w-full bg-white p-8 rounded-lg shadow border border-gray-200">
      ...
      <div className="text-gray-700 space-y-6 leading-relaxed">
        <p>
          TurboBytes Innovations was founded on 23rd July 2025 with one clear mission — to deliver high-quality digital services at affordable prices, and with lightning-fast turnaround.
        </p>
        ...
        <p>
          TurboBytes isn't just a one-time service — we're building an ecosystem. We're soon expanding into SEO, website hosting, and monthly maintenance plans, offering end-to-end solutions to keep your online presence running smooth and strong.
        </p>
