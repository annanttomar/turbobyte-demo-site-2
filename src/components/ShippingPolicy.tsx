  ...
  <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-16">
    <div className="max-w-2xl w-full bg-white p-8 rounded-lg shadow border border-gray-200">
      ...
      <div className="text-gray-700 space-y-4">
        <p>
          At TurboBytes, we are a digital-first service provider based in Odisha, India, offering web development, hosting, and digital solutions. As we specialize in digital products and services, shipping of physical goods is not applicable to our business.
        </p>
