  ...
  <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-16">
    <div className="max-w-4xl w-full bg-white p-8 rounded-lg shadow border border-gray-200">
      ...
      <div className="bg-gray-50 p-4 rounded-lg mb-6">
        ...
        <p><strong>Email:</strong> <a href="mailto:support@turbobytes.in" className="text-blue-600 hover:text-blue-800">support@turbobytes.in</a></p>
      </div>

      <div className="text-gray-700 space-y-6">
        <p>
          Welcome to TurboBytes! These Terms and Conditions ("Terms") govern your use of our website and our services. By accessing or using our website or services, you agree to be bound by these Terms.
        </p>

        <div>
          <h2 className="text-xl font-semibold mb-3 text-gray-800">1. Introduction</h2>
          <p>
            TurboBytes ("we", "our", "us") is a digital service business based in Odisha, India. We currently offer affordable website creation services and plan to expand into SEO, hosting, and maintenance. All services are rendered on a freelance or contractual basis. We are not a registered company or GST entity at this time.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-6 space-y-1 mb-3">
            ...
            <li>Avoid misuse or unethical use of the website created by TurboBytes</li>
          </ul>
        ...
        <div>
          ...
          <p>TurboBytes retains the right to showcase completed projects in its portfolio or on its website unless the client explicitly requests otherwise in writing.</p>
        </div>
        ...
        <div>
          ...
          <p>Unless specified, all templates, design assets, and source code created by TurboBytes are custom-developed for the client. Pre-made assets (e.g., plugins, stock images) are subject to their respective licenses.</p>
        </div>
        ...
        <div>
          ...
          <p className="mb-3">📧 <a href="mailto:support@turbobytes.in" className="text-blue-600 hover:text-blue-800">support@turbobytes.in</a></p>
